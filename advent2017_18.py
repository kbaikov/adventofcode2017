...
@pytest.mark.parametrize("input, expected", [
    ...
    (([('rcv', 'i')], {'a': 10, 'i': 1, 'pointer': 0, 'result': 0, 'end_program': None}),
     ([('rcv', 'i')], {'a': 10, 'i': 1, 'pointer': 0, 'result': 0, 'end_program': True})),

    (([('rcv', 'i')], {'a': 10, 'i': 0, 'pointer': 0, 'result': 0, 'end_program': None}),
     ([('rcv', 'i')], {'a': 10, 'i': 0, 'pointer': 1, 'result': 0, 'end_program': None})),
])
